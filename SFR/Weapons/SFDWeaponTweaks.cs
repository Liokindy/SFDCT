...
internal static class SFDWeaponTweaks
{
    ...
    private static class SFDWpnAssaultRifle
    {
        ...
        private static IEnumerable<CodeInstruction> OnSubAnimationEvent(IEnumerable<CodeInstruction> instructions)
        {
            ...
            code.ElementAt(18).operand = AccessTools.Method(SFR.Game.SoundHandler.typeof_soundHandler, SFR.Game.SoundHandler.nameof_soundHandlerPlaySound, SFR.Game.SoundHandler.typeof_StringVector2Gameworld);
            code.ElementAt(25).operand = AccessTools.Method(SFR.Game.SoundHandler.typeof_soundHandler, SFR.Game.SoundHandler.nameof_soundHandlerPlaySound, SFR.Game.SoundHandler.typeof_StringVector2Gameworld);
    ...
    private static class SFDWpnDarkShotgun
    {
        ...
        private static IEnumerable<CodeInstruction> OnSubAnimationEvent(IEnumerable<CodeInstruction> instructions)
        {
            ...
            code.ElementAt(17).operand = AccessTools.Method(SFR.Game.SoundHandler.typeof_soundHandler, SFR.Game.SoundHandler.nameof_soundHandlerPlaySound, SFR.Game.SoundHandler.typeof_StringVector2Gameworld);
            code.ElementAt(25).operand = AccessTools.Method(SFR.Game.SoundHandler.typeof_soundHandler, SFR.Game.SoundHandler.nameof_soundHandlerPlaySound, SFR.Game.SoundHandler.typeof_StringVector2Gameworld);
            code.ElementAt(33).operand = AccessTools.Method(SFR.Game.SoundHandler.typeof_soundHandler, SFR.Game.SoundHandler.nameof_soundHandlerPlaySound, SFR.Game.SoundHandler.typeof_StringVector2Gameworld);
        ...
        private static IEnumerable<CodeInstruction> OnPostFireAnimationEvent(IEnumerable<CodeInstruction> instructions)
        {
            ...
            code.ElementAt(51).operand = AccessTools.Method(SFR.Game.SoundHandler.typeof_soundHandler, SFR.Game.SoundHandler.nameof_soundHandlerPlaySound, SFR.Game.SoundHandler.typeof_StringVector2Gameworld);
            code.ElementAt(59).operand = AccessTools.Method(SFR.Game.SoundHandler.typeof_soundHandler, SFR.Game.SoundHandler.nameof_soundHandlerPlaySound, SFR.Game.SoundHandler.typeof_StringVector2Gameworld);
    ...
    private static class SFDWpnSawedOffShotgun
    {
        ...
        private static IEnumerable<CodeInstruction> OnReloadAnimationFinished(IEnumerable<CodeInstruction> instructions)
        {
            ...
            code.ElementAt(7).operand = AccessTools.Method(SFR.Game.SoundHandler.typeof_soundHandler, SFR.Game.SoundHandler.nameof_soundHandlerPlaySound, SFR.Game.SoundHandler.typeof_StringVector2Gameworld);
    ...
    private static class SFDWpnAxe
    {
        ...
        private static IEnumerable<CodeInstruction> Destroyed(IEnumerable<CodeInstruction> instructions)
        {
            ...
            code.ElementAt(3).operand = AccessTools.Method(SFR.Game.SoundHandler.typeof_soundHandler, SFR.Game.SoundHandler.nameof_soundHandlerPlaySound, SFR.Game.SoundHandler.typeof_StringVector2Gameworld);
    ...
    private static class SFDWpnChainsaw
    {
        ...
        private static IEnumerable<CodeInstruction> Destroyed(IEnumerable<CodeInstruction> instructions)
        {
            ...
            code.ElementAt(3).operand = AccessTools.Method(SFR.Game.SoundHandler.typeof_soundHandler, SFR.Game.SoundHandler.nameof_soundHandlerPlaySound, SFR.Game.SoundHandler.typeof_StringVector2Gameworld);
            code.ElementAt(52).operand = AccessTools.Method(SFR.Game.SoundHandler.typeof_soundHandler, SFR.Game.SoundHandler.nameof_soundHandlerPlaySound, SFR.Game.SoundHandler.typeof_StringVector2Gameworld);
        ...
        private static IEnumerable<CodeInstruction> OnSubAnimationEvent(IEnumerable<CodeInstruction> instructions)
        {
            ...
            code.ElementAt(18).operand = AccessTools.Method(SFR.Game.SoundHandler.typeof_soundHandler, SFR.Game.SoundHandler.nameof_soundHandlerPlaySound, SFR.Game.SoundHandler.typeof_StringVector2Gameworld);
            code.ElementAt(30).operand = AccessTools.Method(SFR.Game.SoundHandler.typeof_soundHandler, SFR.Game.SoundHandler.nameof_soundHandlerPlaySound, SFR.Game.SoundHandler.typeof_StringVector2Gameworld);
            code.ElementAt(35).operand = AccessTools.Method(SFR.Game.SoundHandler.typeof_soundHandler, SFR.Game.SoundHandler.nameof_soundHandlerPlaySound, SFR.Game.SoundHandler.typeof_StringVector2Gameworld);
        ...
        private static IEnumerable<CodeInstruction> UpdateExtraMeleeState(IEnumerable<CodeInstruction> instructions)
        {
            ...
            code.ElementAt(155).operand = AccessTools.Method(SFR.Game.SoundHandler.typeof_soundHandler, SFR.Game.SoundHandler.nameof_soundHandlerPlaySound, SFR.Game.SoundHandler.typeof_StringVector2Gameworld);
            code.ElementAt(203).operand = AccessTools.Method(SFR.Game.SoundHandler.typeof_soundHandler, SFR.Game.SoundHandler.nameof_soundHandlerPlaySound, SFR.Game.SoundHandler.typeof_StringVector2Gameworld);
