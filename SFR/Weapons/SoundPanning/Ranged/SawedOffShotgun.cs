...
[HarmonyPatch]
internal static class SawedOffShotgun
{
    [HarmonyTranspiler]
    ...
    private static IEnumerable<CodeInstruction> OnReloadAnimationFinished(IEnumerable<CodeInstruction> instructions)
    {
        ...
        code.Insert(6, new CodeInstruction(OpCodes.Callvirt, AccessTools.PropertyGetter(typeof(Player), nameof(Player.Position))));
        return code;
    }
}
